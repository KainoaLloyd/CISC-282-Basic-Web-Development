	...
	<?php
		...
		for($index = 0; $index < count($categories); $index++){
			...
			if ($categories[$index] == "Appetizer"){
				...
				print '<img src="desserts.jpg" alt="desserts" style="width:300px;height:300px">';
			}elseif ($categories[$index] == 'Meat/Fish/Poultry'){
				print '<img src="meat.jpg" alt="meat" style="width:300px;height:300px">';
			}elseif ($categories[$index] == "Other"){
				print '<img src="waffles.jpg" alt="waffles" style="width:300px;height:300px">';
